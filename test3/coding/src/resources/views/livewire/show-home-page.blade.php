            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="block text-center text-lg-start pe-0 pe-xl-5">
                        <h1 class="text-capitalize mb-4">{{ $page->name ?? '' }}</h1>
                        <p class="mb-4">{{ $page->description ?? '' }}</p> <a type="button" class="btn btn-primary"
                ...
                <div class="col-lg-6">
                    <div class="ps-lg-5 text-center">
                        <img loading="lazy" decoding="async" src="{{ $page->image ?? '' }}" alt="banner image"
                            class="w-100">
                    </div>
                </div>
            </div>
