            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="block text-center text-lg-start pe-0 pe-xl-5">
                        ...
                        <p class="mb-4">{{ $config->description ?? '' }}</p> <a type="button" class="btn btn-primary"
                            href="#" data-bs-toggle="modal" data-bs-target="#applyLoan">See More<span
                                style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span></a>
                    </div>
                </div>
                <div class="col-lg-6">
                    {{-- <div class="ps-lg-5 text-center">
                        <img loading="lazy" decoding="async" src="{{ asset('storage/' . $config->image) }}"
                            alt="banner image" class="img-fluid rounded shadow-lg w-75"
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="section-title pt-4">
                        ...
                        <p>Explore a range of digital services designed to simplify your daily needs. Fast, secure, and
